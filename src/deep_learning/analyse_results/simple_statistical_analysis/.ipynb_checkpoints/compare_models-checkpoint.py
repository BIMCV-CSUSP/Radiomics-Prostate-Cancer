...
def main():
    ...
    parser.add_argument("--root_path", type=str, default="../../../../../data/results/deep_learning/gland/results", 
                        help="Ruta a la carpeta raíz que contiene los resultados")
    parser.add_argument("--output_dir", type=str, default="results_gland_analysis", 
