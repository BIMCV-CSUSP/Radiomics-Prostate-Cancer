...
logger.propagate = False  # Evita que se propaguen mensajes al logger raíz
...
# Creamos un handler para el archivo de log
file_handler = logging.FileHandler("radiomics_processing.log", mode='w')
...
adc_features_gland_csv = "mod_features_adc_gland.csv"
dwi_features_gland_csv = "mod_features_dwi_gland.csv"

t2_features_full_csv   = "mod_features_t2_full.csv"
adc_features_full_csv  = "mod_features_adc_full.csv"
dwi_features_full_csv  = "mod_features_dwi_full.csv"
