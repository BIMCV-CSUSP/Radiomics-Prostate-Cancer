...
class MyDataLoader:
    """Load full-field multi-parametric MRI volumes for grouped cross-validation."""
    ...
    def __init__(
        ...
        self.select_items = [SelectItemsd(keys=["image", "label", "patient_id", "study_id"])]
    ...
    def get_all_data(self):
        """Return the pre-indexed dataset entries before any fold split is applied."""
