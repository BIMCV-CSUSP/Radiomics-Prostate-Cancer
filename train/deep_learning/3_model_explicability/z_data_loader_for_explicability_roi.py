...
class MyDataLoader:
    ...
    def __init__(
        ...
        self.base_transforms = [
            # 1) Cargar todas las imágenes y la máscara
            LoadImaged(
            ...
            # 4) Concatenar imágenes originales (completas) antes de aplicar máscara
            ConcatItemsd(
                keys=["t2", "adc", "dwi"],
                name="image_full",  
                dim=0
            ),
            # 5) Aplicar la máscara a cada modalidad
            MaskIntensityd(
                keys=["t2", "adc", "dwi"],
                mask_key="mask",
            ...
            # 7) Concatenar imágenes enmascaradas
            ConcatItemsd(
                keys=["t2", "adc", "dwi"],
                name="image",
                dim=0
        ...
        self.select_items = [SelectItemsd(keys=["image", "image_full", "mask", "label"])]
